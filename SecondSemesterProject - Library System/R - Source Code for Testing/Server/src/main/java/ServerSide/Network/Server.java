...
public class Server implements RMIServer
{
  ...
  @Override
  public boolean registrer(Customer customer)
  {
  ...
  @Override
  public void registerClientItems(ClientCallback clientCallback)
  {
  ...
  @Override
  public String getProductionCompany(int id)
  {
    return serverModel.getProductionCompany(id);
  }

  @Override
  public Info borrow(long cpr, int id, String type)
  {
    return serverModel.borrow(cpr, id, type);
  }

  @Override
  public void borrowconfirm(long cpr, int id, String type, LocalDate date)
  {
    serverModel.borrowconfirm(cpr, id, type,date);
  }

  @Override
  public List<MyItem> getitems(long cpr)
  {
    return serverModel.getitems(cpr);
  }

  @Override
  public boolean returnItem(MyItem item,long cpr)
  {
   return serverModel.returnItem(item,cpr) ;
  }

  @Override
  public boolean checkCount(long cpr)
  {
    return serverModel.checkCount(cpr);
  }

  @Override
  public List<Item> searchItem(String category, String searchtext)
  {
    return serverModel.searchItem(category,searchtext);
  }

  @Override
  public String getGenre(int id, String type)
  {
