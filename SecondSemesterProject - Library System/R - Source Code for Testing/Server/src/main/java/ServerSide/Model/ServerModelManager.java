...
public class ServerModelManager implements ServerModel
{
  ...
  public ServerModelManager(CustomerDAO customerDAO, BookDAO bookDAO, AuthorDAO authorDAO,
          MovieDAO movieDAO,
  ...
  @Override
  public synchronized boolean register(Customer customer)
  {
  ...
  @Override
  public synchronized boolean change(Customer customer)
  {
  ...
  @Override
  public synchronized String getname(Customer customer)
  {
  ...
  @Override
  public synchronized List<Item> getList()
  {
  ...
  @Override
  public synchronized String getAuthor(int id)
  {
    String returnString = "";
  ...
  @Override
  public synchronized String getDeveloper(int id)
  {
    String returnString = "";
  ...
  @Override
  public synchronized String getProductionCompany(int id)
  {
    String returnString = "";
  ...
  @Override
  public synchronized Info borrow(long cpr, int id, String type)
  {
  ...
  @Override
  public synchronized void borrowconfirm(long cpr, int id, String type,
      LocalDate date)
  {
  ...
  @Override
  public synchronized List<MyItem> getitems(long cpr)
  {
  ...
  @Override
  public synchronized boolean returnItem(MyItem item, long cpr)
  {
      switch (item.getType())
      {
        case "Book":
  ...
  @Override
  public synchronized boolean checkCount(long cpr)
  {
  ...
  @Override
  public synchronized List<Item> searchItem(String category, String searchtext)
  {
  ...
  @Override
  public synchronized String getGenre(int id, String type)
  {
    String genre = "";
    switch (type)
    {
