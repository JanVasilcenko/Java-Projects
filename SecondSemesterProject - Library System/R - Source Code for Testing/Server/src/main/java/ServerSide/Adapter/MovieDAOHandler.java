...
public class MovieDAOHandler implements MovieDAO
{
  ...
  public MovieDAOHandler(Connection connection)
  {
    this.connection = connection;
  }

  public List<Movie> convertMovies(ResultSet resultSet)
  {
  ...
  @Override
  public ArrayList<Movie> searchMovies(String searchString)
  {
    try
    {
