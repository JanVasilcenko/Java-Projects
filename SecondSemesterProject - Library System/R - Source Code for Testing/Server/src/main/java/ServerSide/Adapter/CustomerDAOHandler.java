...
public class CustomerDAOHandler implements CustomerDAO
{
  ...
  public CustomerDAOHandler(Connection connection)
  {
  ...
  public List<Long> convertCpr(ResultSet resultSet)
  {
  ...
  public List<String> convertPassword(ResultSet resultSet)
  {
  ...
  @Override
  public ArrayList<String> findPassword()
  {
    ...
    public List<Customer> convertCustomer(ResultSet resultSet)
    {
  ...
  @Override
  public boolean setName(Customer customer)
  {
    try
    {
  ...
  @Override
  public boolean setaddress(Customer customer)
  {
    try
    {
  ...
  @Override
  public boolean setpassword(Customer customer)
  {
    try
    {
  ...
  @Override
  public boolean setCreditcard(Customer customer)
  {
    try
    {
