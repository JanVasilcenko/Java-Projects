...
public class ProductionCompanyDAOHandler implements ProductionCompanyDAO
{
  ...
  public ProductionCompanyDAOHandler(Connection connection)
  {
    this.connection = connection;
  }

  public List<String> convertProductionCompanies(ResultSet resultset)
  {
  ...
  @Override
  public ArrayList<String> getProductionCompanies(int id)
  {
    try
    {
