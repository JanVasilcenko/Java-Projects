...
public class HasBorrowedMovieDAOHandler implements HasBorrowedMovieDAO
{
  ...
  public HasBorrowedMovieDAOHandler(Connection connection)
  {
  ...
  public List<MyItem> convertMyMovies(ResultSet resultSet)
  {
  ...
  @Override
  public ArrayList<MyItem> getMyMovies(long cpr)
  {
    try
    {
