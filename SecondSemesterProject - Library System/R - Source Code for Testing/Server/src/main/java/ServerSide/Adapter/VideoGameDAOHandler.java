...
public class VideoGameDAOHandler implements VideoGameDAO {
	...
	public VideoGameDAOHandler(Connection connection) {
		this.connection = connection;
	}
	
	public List<Game> convertGames(ResultSet resultSet) {
	...
	@Override
	public ArrayList<Game> searchBooks(String searchString) {
		try {
