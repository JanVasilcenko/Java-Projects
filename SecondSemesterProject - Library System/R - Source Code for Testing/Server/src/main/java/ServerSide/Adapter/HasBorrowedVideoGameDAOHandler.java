...
public class HasBorrowedVideoGameDAOHandler implements HasBorrowedVideoGameDAO
{
  ...
  public HasBorrowedVideoGameDAOHandler(Connection connection)
  {
    this.connection = connection;
  }

  @Override
  public void hasBorrowed(long cpr, int id, LocalDate dateFrom,
      LocalDate dateDue)
  {
    try
    {
  ...
  public List<Reservation> convertReservations(ResultSet resultSet)
  {
  ...
  public List<MyItem> convertMyVideoGames(ResultSet resultSet)
  {
  ...
  @Override
  public ArrayList<MyItem> getMyVideoGames(long cpr)
  {
    try
    {
  ...
  @Override
  public void delete(long cpr, int id)
  {
    try
    {
  ...
  @Override
  public void updateDates(long cpr, int id, LocalDate dateFrom,
      LocalDate dateDue)
  {
    try
    {
  ...
  public int convertCount(ResultSet resultSet)
  {
    try
    {
      while(resultSet.next())
  ...
  @Override
  public int checkCount(long cpr)
  {
    try
    {
