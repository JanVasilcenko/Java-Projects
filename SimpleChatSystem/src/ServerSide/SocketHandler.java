...
import Shared.SharedObjects.Request;
...
public class SocketHandler implements Runnable
{
  ...
  @Override public void run()
  {
    try
    {
      ...
      if("Listen".equals(request.getType()))
      {
      ...
      else if("List".equals(request.getType()))
      {
        List<Message> log = messageManager.getMessage();
        outToClient.writeObject(new Request("List", log));
      }
      ...
      else if("ClientPlus".equals(request.getType()))
      {
